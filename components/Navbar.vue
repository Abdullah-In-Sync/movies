<template>
    <!-- component -->
    <nav class=" bg-black text-white w-full flex relative justify-between items-center mx-auto px-8 h-20">
        <!-- logo -->
        <div class="inline-flex">
            <NuxtLink class="_o6689fn" href="/">
                ...
                <div class="inline-flex items-center max-w-full">
                    <div
                        ...
                        <input v-model="search" type="text"
                            class="block flex-grow flex-shrink overflow-hidden bg-black text-white border-none focus:ring-0"
                            placeholder="Start Your Search">
                        <NuxtLink onClick="" class="flex items-center justify-center relative  h-8 w-8 rounded-full cursor-pointer"
                            :to="'/search/' + search">
        ...
        <div class="flex-initial">
            <div class="flex justify-end items-center relative">
                ...
                <div class="flex mr-4 items-center">
                    <NuxtLink class="inline-block py-2 px-3 hover:bg-gray-200 rounded-full" href="#">
